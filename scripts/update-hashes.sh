...
FILES=(
    ...
    "for-managers/iso-hash-qr.svg"
    "27001.iso"
    "27001-iso/README.txt"
    "27001-iso/nis2-roles.html"
    "27001-iso/nukib-contacts.vcf"
    "27001-iso/zakon-264-2025-summary.txt"
    "27001-iso/zokb-deadlines.ics"
